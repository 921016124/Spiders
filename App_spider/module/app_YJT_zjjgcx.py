...
class Yjt:
    def __init__(self):
        self.u = Util()
        self.url = "https://app.finchina.com/finchinaAPP/getOrgFamilyCreaditData_SE.action?selTopRecommended=%E4%B8%AD%E4%BB%8B%E6%9C%BA%E6%9E%84%E8%AF%9A%E4%BF%A1&skip={}"
            #"https://app.finchina.com/finchinaAPP/getBondsDefaultDynamics.action?pageNum={}&pageSize=15"
        self.file = "Scrapyed_zjjgcx.txt"
        self.headers = {
    ...
    def parse_detail(self, response):
        ...
        for i in detail_datas:
            ...
            self.u.insert2mysql(about_people, self.zjjgcx_sql(zjjgcx_data))

    def zjjgcx_sql(self, data):
        sql = """insert into 
        yjt_zjjgcx(id, pub_date, about_people,handle_people, punish_type, irregularities, 
